...
/*<!--		REPLACE NO-ASCII*/
/*				$channel["channel_name"] = preg_replace('/ü/', 'ue', $channel["channel_name"]);
				$channel["channel_name"] = preg_replace('/[[:^print:]]/', '_', $channel["channel_name"]);
*/
/*<!--##	REMOVE SPACERS: draw lines  -->*/
				if (preg_match( "/^\[spacer.*\]___\z/" , $channel["channel_name"] )) {
/*					 $channel["channel_name"] = "-----------------------------------------------------";	*/
					 $channel["channel_name"] = "_____________________________________________________";
				} 

/*<!--##	REMOVE SPACERS: input whitespaces  -->*/
				$channel["channel_name"] = preg_replace("/^\[cspacer-.*\]/", "       ", $channel["channel_name"] );
